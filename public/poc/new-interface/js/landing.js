var landing = Vue.component('landing',{
    data: function(){
        return {
            ...
            clientLogo: window.localStorage.getItem('client-logo')? window.localStorage.getItem('client-logo') : './img/alignet-color.png',
            site: site,
        ...
        <header class="header container-fluid header-color header-text">
            <div class="row justify-content-between">
                <a href="javascript:void(0)" @click="$router.push('/')" style="padding:10px">
                    <img id="business-logo" src="./img/reconprime-logo.png" alt="logo">
                </a>
                <div class="header-left-section d-flex align-self-end ml-auto" style="padding:10px">
                    <a id="user-panel">
                        <div class="user-image-holder"></div>
                    </a>
                    <!-- <span class="d-flex flex-column justify-content-between mr-4">
                        <div class="login d-flex flex-column">
                            <div>CBARBERA</div>
                            <div>ISERIES</div>
                            <div>{{new Date().toLocaleString()}}</div>
                            <a @click="logout" class="logout header-text d-flex justify-content-center align-items-center">
                                <object class="logout-icon pt-2" data="./img/menu-icons/logout.svg" type="image/svg+xml"></object>
                                <span>Cerrar sesión</span>
                            </a>
                        </div>
                    </span> -->
                    <div id="user-popover" class="user-popover" style="color:black">
                        <h5 class="mb-0" style="color:black">Hola, <b>Carlos Barbera</b></h5>
                        <div class="text-secondary" style="font-size:0.8rem">ISeries USA - CBARBERA</div>
                        ...
                        <div class="user-option">
                            <a href="javascript:void(0)">Acerca de Reconprime</a>
                        </div>
                        <hr class="w-100">
                    ...
                    <img id="client-logo" class="logo client-logo" v-bind:src="clientLogo" alt="logo">
                </div>
            </div>
        </header>
        ...
        <div class="container-fluid main-container flex-grow-1">
            <div class="row flex-grow-1">
                <div style="display:block">
                    ...
                    <!-- <sidebar :arropcs="sidemenu"></sidebar> -->
                </div>
                <div class="main-content-container col p-0">
                    <navigation></navigation>
                    <router-view class="main-content" :menu="menu" v-on:logo-change="setClientLogo" v-on:change-palette="updateApplicationPalette" v-on:toggle-divisor="updateDivisorVisibility"></router-view>
                </div>
            </div>
        </div>
